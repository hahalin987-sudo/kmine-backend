module.exports = {
  ...
  checklists: [
    { date: '2024-11-01', vehicle: 'KAM-001', vehiclePlate: 'KAM-001', driver: '陈刚', template: '日常点检', passed: true, team: '公司', items: [{name:'刹车系统',passed:true},{name:'轮胎状况',passed:true},{name:'灯光信号',passed:true},{name:'后视镜',passed:true},{name:'喇叭',passed:true},{name:'转向系统',passed:true}], notes: '一切正常' },
    { date: '2024-11-01', vehicle: 'KAM-002', vehiclePlate: 'KAM-002', driver: '李伟', template: '日常点检', passed: true, team: '公司', items: [{name:'刹车系统',passed:true},{name:'轮胎状况',passed:true},{name:'灯光信号',passed:true},{name:'后视镜',passed:true},{name:'喇叭',passed:true},{name:'转向系统',passed:false}], notes: '转向系统有轻微异响' },
    { date: '2024-11-02', vehicle: 'KAM-003', vehiclePlate: 'KAM-003', driver: '王磊', template: '日常点检', passed: true, team: '公司', items: [{name:'刹车系统',passed:true},{name:'轮胎状况',passed:true},{name:'灯光信号',passed:true},{name:'后视镜',passed:true},{name:'喇叭',passed:true},{name:'转向系统',passed:true}], notes: '' },
    { date: '2024-11-03', vehicle: 'KAM-004', vehiclePlate: 'KAM-004', driver: '周亮', template: '日常点检', passed: false, team: '公司', items: [{name:'刹车系统',passed:false},{name:'轮胎状况',passed:true},{name:'灯光信号',passed:true},{name:'后视镜',passed:true},{name:'喇叭',passed:true},{name:'转向系统',passed:true}], notes: '刹车气压不足，需要充气' },
    { date: '2024-11-05', vehicle: 'BULL-001', vehiclePlate: 'BULL-001', driver: '张强', template: '日常点检', passed: true, team: '公司', items: [{name:'刹车系统',passed:true},{name:'轮胎状况',passed:true},{name:'灯光信号',passed:true},{name:'后视镜',passed:true},{name:'喇叭',passed:true},{name:'转向系统',passed:true}], notes: '' },
    { date: '2024-11-07', vehicle: 'WAT-001', vehiclePlate: 'WAT-001', driver: '孙鹏', template: '日常点检', passed: true, team: '公司', items: [{name:'刹车系统',passed:true},{name:'轮胎状况',passed:true},{name:'灯光信号',passed:true},{name:'后视镜',passed:true},{name:'喇叭',passed:true},{name:'转向系统',passed:true}], notes: '' },
  ],
